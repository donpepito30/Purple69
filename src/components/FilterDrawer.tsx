    ...
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex justify-end">
      <div className="bg-zinc-950 border-l border-zinc-800 w-full max-w-md h-full flex flex-col p-6 shadow-2xl overflow-y-auto animate-in slide-in-from-right">
          ...
          <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <label
                ...
                className="flex items-center justify-between p-3 rounded-2xl bg-zinc-900 border border-zinc-800 cursor-pointer hover:border-violet-500/50 transition"
              >
                <div className="flex items-center gap-2">
                ...
                <div
                  className={`w-5 h-5 rounded-md flex items-center justify-center border ${
                    filters.isHdOnly ? 'bg-violet-600 border-violet-500 text-white' : 'border-zinc-700'
                  }`}
                >
        ...
        <div className="pt-4 border-t border-zinc-800 space-y-2">
          <button
            onClick={onClose}
            className="w-full py-3 rounded-2xl bg-violet-600 hover:bg-violet-500 text-white font-extrabold text-xs shadow-lg shadow-violet-950/40"
          >
