          ...
          <div className="hidden md:flex flex-1 max-w-md relative">
            <div className="relative w-full">
              ...
              <input
                ...
                className="w-full bg-zinc-900/90 text-sm text-zinc-100 placeholder-zinc-500 pl-10 pr-9 py-2 rounded-full border border-zinc-800 focus:border-violet-500/80 focus:ring-2 focus:ring-violet-500/20 outline-none transition-all"
              />
              {localSearch && (
                <button
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="relative">
              <button
                ...
                className="p-2.5 rounded-xl bg-zinc-900 border border-zinc-800 text-zinc-300 hover:text-violet-400 transition relative"
                title="Modelos Favoritas"
              >
                <Heart className={`w-4 h-4 ${favoriteModels.length > 0 ? 'fill-violet-500 text-violet-500' : ''}`} />
                {favoriteModels.length > 0 && (
                  <span className="absolute -top-1 -right-1 w-4 h-4 rounded-full bg-violet-600 text-[10px] font-bold text-white flex items-center justify-center">
                      ...
                      {favoriteModels.map((m) => (
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="text-xs font-bold text-white group-hover:text-violet-400 truncate">
                              {m.displayName}
                            </div>
            ...
            <div className="flex items-center bg-zinc-900 rounded-xl p-1 border border-zinc-800">
              ...
              <button
                ...
                className="bg-gradient-to-r from-amber-500 to-violet-600 hover:from-amber-400 hover:to-violet-500 text-zinc-950 font-bold text-xs px-2.5 py-1.5 rounded-lg transition shadow-md shadow-amber-950/20"
              >
                + Comprar
              </button>
            </div>
