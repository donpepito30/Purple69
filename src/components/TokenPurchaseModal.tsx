    ...
    <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4">
      <div className="bg-zinc-950 border border-zinc-800 rounded-3xl max-w-lg w-full p-6 space-y-5 shadow-2xl relative animate-in zoom-in-95">
        ...
        <div className="text-center space-y-1.5">
          <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-amber-500 to-violet-600 flex items-center justify-center mx-auto shadow-lg shadow-amber-950/40">
          ...
          <>
            ...
            <div className="grid grid-cols-2 gap-3">
              {TOKEN_PACKAGES.map((pack) => {
                ...
                return (
                  ...
                  >
                    {pack.popular && (
                      <span className="absolute -top-2.5 right-3 bg-gradient-to-r from-amber-500 to-violet-600 text-zinc-950 text-[9px] font-black uppercase px-2 py-0.5 rounded-full shadow">
                        MEJOR VALOR
                      </span>
                    )}
            ...
            <div className="bg-zinc-900 p-4 rounded-2xl border border-zinc-800 space-y-3">
              ...
              <button
                ...
                className="w-full py-3.5 rounded-xl bg-gradient-to-r from-amber-500 via-violet-600 to-amber-500 hover:opacity-95 text-zinc-950 font-black text-sm shadow-xl shadow-amber-950/40 flex items-center justify-center gap-2 transition"
              >
                {isProcessing ? (
