      ...
      <div className="bg-zinc-950 border border-zinc-800 rounded-3xl max-w-4xl w-full h-full max-h-[85vh] flex flex-col shadow-2xl overflow-hidden relative">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="font-extrabold text-base text-white flex items-center gap-2">
                ...
                <span className="text-[10px] bg-violet-600 text-white px-2 py-0.5 rounded-md font-bold">ONLINE MODELS LIST</span>
              </h2>
              <p className="text-xs text-zinc-400">
                Respuesta estructurada conforme a la especificación oficial de Stripcash API (<code className="text-violet-400">api/models</code>).
              </p>
            </div>
          </div>
        ...
        {activeTab === 'tester' && (
          <div className="flex-1 p-5 overflow-y-auto space-y-4">
            ...
            {/* Request URL */}
            <div className="bg-zinc-900/90 p-3 rounded-2xl border border-zinc-800 flex items-center justify-between text-xs font-mono text-violet-400 overflow-x-auto">
              <span className="truncate mr-2">GET {endpointUrl}</span>
              <div className="flex gap-2 shrink-0">
                <button
                  onClick={fetchApiResponse}
                  className="px-3 py-1.5 rounded-xl bg-violet-600 hover:bg-violet-500 text-white font-sans font-bold flex items-center gap-1"
                >
          ...
          <div className="flex-1 p-5 overflow-y-auto space-y-4 text-xs">
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-2xl overflow-hidden divide-y divide-zinc-800">
              ...
              <div className="p-3 grid grid-cols-3 text-zinc-300">
                <code className="text-violet-400 font-mono">gender</code>
                <span>string</span>
                <span>Filtrar género: female, male, couple, trans, all</span>
              </div>
              <div className="p-3 grid grid-cols-3 text-zinc-300">
                <code className="text-violet-400 font-mono">status</code>
                <span>string</span>
                <span>Filtrar estado: online, private, away, all</span>
              </div>
              <div className="p-3 grid grid-cols-3 text-zinc-300">
                <code className="text-violet-400 font-mono">limit / per_page</code>
                <span>integer</span>
                <span>Cantidad máxima de registros devueltos</span>
              </div>
              <div className="p-3 grid grid-cols-3 text-zinc-300">
                <code className="text-violet-400 font-mono">aff / affiliate_id</code>
                <span>string</span>
